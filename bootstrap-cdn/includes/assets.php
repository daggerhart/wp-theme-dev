...
function awesomesauce_scripts() {
	 ...
	 */
	// core bootstrap
	wp_enqueue_style( 'bootstrap-min-css', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css', array(), $version );

	// optional bootstrap styles
	wp_enqueue_style( 'bootstrap-theme-css', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap-theme.min.css', array(), $version );
